...
function BubbleChart(data,options) {
	...
	*/
	...
	function Legend() {
		...
		var radius=25,
			radius_inner=10; //gdp_scale(gdp)
		var x=radius+16,//margins.left;//WIDTH - gdp_scale(gdp) - 20,
			y=WIDTH<768?HEIGHT-28:yscale_countries.range()[1]+margins.top+radius*2 + 30;
